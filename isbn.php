                        ...
                        while ($row = mysql_fetch_row($result)) {
                            ...
                            if (!$result2) {
                                ...
                                while ($row2 = mysql_fetch_row($result2)) {
                                    $breadcrumb = ' &gt; <a href="isbn.php">ISBN</a>';
                                    ?>
                                    <div class="item">
                                        <a href="item.php?isbn=<?php echo $row2[1]; ?>&breadcrumb=<?php echo urlencode($breadcrumb) ?>"><?php echo $row2[1] . ': ' . $row2[0]; ?></a>
                                    </div>
                                    <?php
                                }
                            }
